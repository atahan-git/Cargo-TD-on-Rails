...
namespace CartoonFX
{
    ...
    public class CFXR_ParticleText : MonoBehaviour
    {
        ...
        [SerializeField] float cumulativeDelay = 0.02f;
...
#pragma warning restore 0649
        ...
        )
        {
            ...
            if (charCount > 0)
            {
                ...
                var realRotation = Random.Range(-rotation, rotation);
                for (int i = 0; i < text.Length; i++)
                {
                    var letter = text[i];
                    ...
                    else
                    {
                        ...
                        mainModule.startRotation = Mathf.Deg2Rad * (realRotation);
                        ...
                        mainModule.startDelay = delay + cumulativeDelay * i;
